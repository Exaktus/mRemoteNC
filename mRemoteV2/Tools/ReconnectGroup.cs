...
namespace mRemoteNC
{
    public partial class ReconnectGroup
    {
        ...
        public bool ServerReady
        {
            ...
            set
            {
                SetStatusImage(value == true
                                   ? global::My.Resources.Resources.HostStatus_On
                                   : global::My.Resources.Resources.HostStatus_Off);
        ...
        {
            add { CloseClickedEvent = (CloseClickedEventHandler) System.Delegate.Combine(CloseClickedEvent, value); }
            remove { CloseClickedEvent = (CloseClickedEventHandler) System.Delegate.Remove(CloseClickedEvent, value); }
        }
