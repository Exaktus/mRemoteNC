        ...
        namespace Window
        {
            public class ComponentsCheck : Base
            {
                ...
                private void CheckComponents()
                {
                    ...
                    AxMSTSCLib.AxMsRdpClient7NotSafeForScripting RDP = null;
                    try
                    {
                        ...
                        txtCheck1.Text = string.Format(Language.strCcRDPOK, RDP.Version);
                    }
                    catch (Exception ex)
                    {
                    ...
                    {
                        pPath = (string)Settings.Default.CustomPuttyPath;
                    }
                    ...
                    else
                    {
                        ...
                        Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                            "File " + pPath + " does not exist.", true);
                    }
                    ...
                    if (Directory.Exists((string)Settings.Default.XULRunnerPath))
                    {
                        if (File.Exists(Path.Combine((string)Settings.Default.XULRunnerPath, "xpcom.dll")) == false)
                        {
                            GeckoBad = true;
                        }
                    }
                    ...
                    catch (Exception ex)
                    {
                        ...
                        txtCheck6.Text = Language.strCcEOLFailed;
                    ...
                    if (File.Exists(Settings.Default.TeamViewerPath))
                    {
                        ...
                        //txtCheck7.Text = Language.strCcEOLOK;
                    }
                    else
                    {
