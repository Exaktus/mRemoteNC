        ...
        namespace Window
        {
            public class ScreenshotManager : Base
            {
                ...
                private void InitializeComponent()
                {
                    ...
                    //msMain
                    //
                    this.msMain.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(8.25F),
                    ...
                    //dlgSaveSingleImage
                    //
                    this.dlgSaveSingleImage.Filter =
                ...
                private void pbScreenshot_MouseDown(System.Object sender, System.Windows.Forms.MouseEventArgs e)
                {
                    ...
                    {
                        this.OpenScreenshot(((PictureBox)sender));
                    }
                }
                ...
                private void pbScreenshotOpen_MouseDown(System.Object sender, System.Windows.Forms.MouseEventArgs e)
                {
                    if (e.Button == System.Windows.Forms.MouseButtons.Left)
                    {
                        this.CloseOpenedScreenshot((Form)((Control)sender).Parent);
                    }
                }
                ...
                private void SaveAllImages()
                {
                    try
                    {
                        ...
                        if (this.dlgSaveAllImages.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                        {
                            foreach (
                                string fPath in
                                    Directory.GetFiles(this.dlgSaveAllImages.SelectedPath, "Screenshot_*",
                            ...
                            foreach (System.Windows.Forms.Control ctrl in this.flpScreenshots.Controls)
                            {
                                if (ctrl is PictureBox)
                                {
                                    (ctrl as PictureBox).Image.Save(
                                        this.dlgSaveAllImages.SelectedPath + "\\Screenshot_" +
                                        Tools.Misc.LeadingZero(pCount.ToString()) + ".png",
                ...
                private void SaveSingleImage()
                {
                    try
                    {
                        ...
                        {
                            switch (
                                this.dlgSaveSingleImage.FileName.Substring(
                                    System.Convert.ToInt32(this.dlgSaveSingleImage.FileName.LastIndexOf(".") + 1)).
                                    ToLower())
                            {
                                case "gif":
                                    (this.cMenScreenshot.Tag as PictureBox).Image.Save(
                                        this.dlgSaveSingleImage.FileName, System.Drawing.Imaging.ImageFormat.Gif);
                                    break;
                                case "jpeg":
                                    (this.cMenScreenshot.Tag as PictureBox).Image.Save(
                                        this.dlgSaveSingleImage.FileName, System.Drawing.Imaging.ImageFormat.Jpeg);
                                    break;
                                case "jpg":
                                    (this.cMenScreenshot.Tag as PictureBox).Image.Save(
                                        this.dlgSaveSingleImage.FileName, System.Drawing.Imaging.ImageFormat.Jpeg);
                                ...
                                case "png":
                                    (this.cMenScreenshot.Tag as PictureBox).Image.Save(
                                        this.dlgSaveSingleImage.FileName, System.Drawing.Imaging.ImageFormat.Png);
                                    break;
                            }
                        }
                    }
