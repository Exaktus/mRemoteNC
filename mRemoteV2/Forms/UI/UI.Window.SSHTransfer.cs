            ...
            public class SSHTransfer : Base
            {
                ...
                private void InitializeComponent()
                {
                    System.ComponentModel.ComponentResourceManager resources =
                        new System.ComponentModel.ComponentResourceManager(typeof(SSHTransfer));
                ...
                private void StartTransfer(SSHTransferProtocol Protocol)
                {
                    ...
                    try
                    {
                        ...
                        sshT.OnTransferStart += new Tamir.SharpSsh.FileTransferEvent(SshTransfer_Start);
                        sshT.OnTransferProgress += new Tamir.SharpSsh.FileTransferEvent(SshTransfer_Progress);
                        sshT.OnTransferEnd += new Tamir.SharpSsh.FileTransferEvent(SshTransfer_End);

                        this.sshT.Connect(int.Parse(this.txtPort.Text));
                ...
                private void StartTransferBG()
                {
                    ...
                    {
                        Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                            Language.strSSHStartTransferBG + Constants.vbNewLine +
                                                            ex.Message, true);
                    }
                }
                ...
                private void SetStatus()
                {
                    ...
                    {
                        pbStatus.Maximum = (int)maxVal;
                        pbStatus.Value = (int)curVal;
                    }
                }
                ...
                private void SshTransfer_Start(string src, string dst, int transferredBytes, int totalBytes,
                                               string message)
                {
                    maxVal = totalBytes;
                ...
                private void SshTransfer_Progress(string src, string dst, int transferredBytes, int totalBytes,
                                                  string message)
                {
                    maxVal = totalBytes;
                    curVal = transferredBytes;
                ...
                private void SshTransfer_End(string src, string dst, int transferredBytes, int totalBytes,
                                             string message)
                {
                    try
                    {
                    ...
                    {
                        Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                            Language.strSSHTransferEndFailed + Constants.vbNewLine +
                                                            ex.Message, true);
                    }
                }
