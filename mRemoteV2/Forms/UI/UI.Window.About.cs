...
using mRemoteNC.App;
using mRemoteNC.Config.SettingsManager.Providers;
using My;
        ...
        namespace Window
        {
            public class About : Base
            {
                ...
                private void InitializeComponent()
                {
                    ...
                    this.llblWeifenLuo.LinkClicked +=
                        new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.llblWeifenLuo_LinkClicked);
                    this.llblMagicLibrary = new System.Windows.Forms.LinkLabel();
                    this.llblMagicLibrary.LinkClicked +=
                        new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.llblMagicLibrary_LinkClicked);
                    this.llblFAMFAMFAM = new System.Windows.Forms.LinkLabel();
                    this.llblFAMFAMFAM.LinkClicked +=
                        new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.llblFAMFAMFAM_LinkClicked);
                    ...
                    //lblEdition
                    //
                    this.lblEdition.Anchor =
                        (System.Windows.Forms.AnchorStyles)
                        (System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right);
                    this.lblEdition.BackColor = System.Drawing.Color.Black;
                    this.lblEdition.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(14.25F),
                    ...
                    this.llblWeifenLuo.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(11.0F),
                    ...
                    this.llblMagicLibrary.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(11.0F),
                                                                         System.Drawing.FontStyle.Regular,
                                                                         System.Drawing.GraphicsUnit.Point, (byte)(0));
                    ...
                    this.llblFAMFAMFAM.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(11.0F),
                                                                      System.Drawing.FontStyle.Regular,
                                                                      System.Drawing.GraphicsUnit.Point, (byte)(0));
                    ...
                    this.txtChangeLog.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(9.0F),
                                                                     System.Drawing.FontStyle.Regular,
                                                                     System.Drawing.GraphicsUnit.Point, (byte)(0));
                    ...
                    this.lblTitle.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(14.0F),
                                                                 System.Drawing.FontStyle.Bold,
                                                                 System.Drawing.GraphicsUnit.Point, (byte)(0));
                    ...
                    this.lblTitle.Text = "mRemoteNC";
                    this.lblTitle.UseCompatibleTextRendering = true;
                    //
                    //lblVersion
                    //
                    this.lblVersion.AutoSize = true;
                    this.lblVersion.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(11.0F),
                                                                   System.Drawing.FontStyle.Regular,
                                                                   System.Drawing.GraphicsUnit.Point, (byte)(0));
                    ...
                    this.lblChangeLog.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(11.0F),
                                                                     System.Drawing.FontStyle.Regular,
                                                                     System.Drawing.GraphicsUnit.Point, (byte)(0));
                    ...
                    this.lblLicense.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(11.0F),
                                                                   System.Drawing.FontStyle.Regular,
                                                                   System.Drawing.GraphicsUnit.Point, (byte)(0));
                    ...
                    this.lblCopyright.Font = new System.Drawing.Font("Microsoft Sans Serif", (float)(11.0F),
                                                                     System.Drawing.FontStyle.Regular,
                                                                     System.Drawing.GraphicsUnit.Point, (byte)(0));
                ...
                private void About_Load(object sender, System.EventArgs e)
                {
                    ...
                    {
                        lblCopyright.Text =
                            (new Microsoft.VisualBasic.ApplicationServices.WindowsFormsApplicationBase()).Info.Copyright;

                        this.lblVersion.Text = "Version " +
                                               (new Microsoft.VisualBasic.ApplicationServices.
                                                   WindowsFormsApplicationBase()).Info.Version.ToString();

                        FillLinkLabel(llblFAMFAMFAM, Language.strFAMFAMFAMAttribution,
                                      Language.strFAMFAMFAMAttributionURL);
                        FillLinkLabel(llblMagicLibrary, Language.strMagicLibraryAttribution,
                                      Language.strMagicLibraryAttributionURL);
                        FillLinkLabel(llblWeifenLuo, Language.strWeifenLuoAttribution,
                                      Language.strWeifenLuoAttributionURL);

                        if (
                            File.Exists(
                                (new Microsoft.VisualBasic.ApplicationServices.WindowsFormsApplicationBase()).Info.
                                    DirectoryPath + "\\CHANGELOG.TXT"))
                        {
                            StreamReader sR =
                                new StreamReader(
                                    (new Microsoft.VisualBasic.ApplicationServices.WindowsFormsApplicationBase()).Info.
                    ...
                    catch (Exception ex)
                    {
                        Runtime.MessageCollector.AddMessage(Messages.MessageClass.ErrorMsg,
                                                            (string)
                                                            ("Loading About failed" + Constants.vbNewLine + ex.Message),
                                                            true);
                    }
                }

                private void llblFAMFAMFAM_LinkClicked(System.Object sender,
                                                       System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
                {
                    Runtime.GoToURL(Language.strFAMFAMFAMAttributionURL);
                }

                private void llblMagicLibrary_LinkClicked(System.Object sender,
                                                          System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
                {
                    Runtime.GoToURL(Language.strMagicLibraryAttributionURL);
                }

                private void llblWeifenLuo_LinkClicked(System.Object sender,
                                                       System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
                {
