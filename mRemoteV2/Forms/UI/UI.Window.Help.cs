    ...
    namespace UI
    {
        namespace Window
        {
            public class Help : Base
            {
                ...
                {
                    this.tvIndex.Nodes[0].Expand();
                    this.tvIndex.SelectedNode = this.tvIndex.Nodes[0].Nodes[0];
                }
                ...
                {
                    this.imgListHelp.Images.Add("File", global::My.Resources.Resources.Page);
                    this.imgListHelp.Images.Add("Folder", global::My.Resources.Resources.Folder);
                    this.imgListHelp.Images.Add("Help", global::My.Resources.Resources.Help);
                }
